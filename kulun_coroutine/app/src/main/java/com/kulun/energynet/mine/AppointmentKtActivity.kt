...
class AppointmentKtActivity : BaseActivity() {
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHolder>() {
        ...
        private fun colorReserverOrExchangeBatteryDone(holder: MyViewHolder) {
            holder.adapterbinding.tvStatus.setTextColor(resources.getColor(R.color.black))
            holder.adapterbinding.tvTime.setTextColor(resources.getColor(R.color.black))
            holder.adapterbinding.tvStation.setTextColor(resources.getColor(R.color.black))
            holder.adapterbinding.carplate.setTextColor(resources.getColor(R.color.black))
        }

        private fun colorNotDone(holder: MyViewHolder) {
            holder.adapterbinding.tvStatus.setTextColor(resources.getColor(R.color.reserverunfinish))
            holder.adapterbinding.tvTime.setTextColor(resources.getColor(R.color.reserverunfinish))
            holder.adapterbinding.tvStation.setTextColor(resources.getColor(R.color.reserverunfinish))
            holder.adapterbinding.carplate.setTextColor(resources.getColor(R.color.reserverunfinish))
        }

        override fun getItemCount(): Int = list.size
    }

    class MyViewHolder(adapterbinding: AdapterReserverBinding) : RecyclerView.ViewHolder(adapterbinding.root) {
